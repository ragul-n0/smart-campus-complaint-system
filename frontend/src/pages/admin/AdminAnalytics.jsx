    ...
    <AdminLayout
      ...
      action={
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-white hover:bg-slate-50 text-slate-700 text-xs font-semibold border border-slate-300 shadow-subtle transition disabled:opacity-50"
        >
    ...
    >
      ...
      {loading && !data ? (
        ...
        <div className="space-y-6">
          ...
          {/* 2. Resolution Time Performance Card */}
