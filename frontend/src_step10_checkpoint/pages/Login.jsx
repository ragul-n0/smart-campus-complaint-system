      ...
      <div className="w-full max-w-md bg-slate-800/90 border border-slate-700/80 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur-md">
        ...
        <form onSubmit={handleSubmit} className="space-x-0 space-y-4">
          ...
          <button
            ...
            className="w-full mt-2 py-3 px-4 rounded-xl bg-teal-600 hover:bg-teal-500 disabled:bg-slate-700 disabled:cursor-not-allowed text-white font-semibold text-sm transition-all duration-200 shadow-lg shadow-teal-700/20 active:scale-[0.99] flex items-center justify-center space-x-2"
          >
            {isSubmitting ? (
              <>
        ...
        <div className="mt-6 pt-5 border-t border-slate-700/60 text-center">
          <p className="text-xs text-slate-400">
            ...
            <Link to="/register" className="text-teal-400 hover:text-teal-300 font-semibold underline-offset-4 hover:underline">
              Create an account
            </Link>
          </p>
        </div>
